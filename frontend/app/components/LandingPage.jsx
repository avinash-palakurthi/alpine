...
const stats = [
  ...
  { num: "€70", label: "Current ETS price per tCO₂" },
...
const sectors = [
  { icon: "🏗️", name: "Steel",       cn: "CN 72-73",  desc: "Hot rolled coils, wire rod, structural steel" },
  { icon: "🔩", name: "Aluminium",   cn: "CN 76",     desc: "Unwrought aluminium, alloys, articles" },
  { icon: "🏭", name: "Cement",      cn: "CN 25",     desc: "Portland cement, clinkers, calcium" },
  { icon: "🌱", name: "Fertilizers", cn: "CN 31",     desc: "Urea, ammonia, nitrogenous compounds" },
  { icon: "⚗️", name: "Hydrogen",    cn: "CN 2804",   desc: "Pure hydrogen and hydrogen compounds" },
  { icon: "🔌", name: "Electricity", cn: "CN 2716",   desc: "Electrical energy imports into EU" },
];
...
export default function LandingPage() {
  ...
  return (
    <div className="font-sans text-gray-900 overflow-x-hidden">
      ...
      {/* NAV */}
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled || menuOpen ? "bg-white shadow-sm border-b border-gray-100" : "bg-transparent"}`}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span className={`font-bold text-xl tracking-tight transition-colors ${scrolled || menuOpen ? "text-gray-900" : "text-white"}`}>
          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            {[
              ...
              <a
                key={label}
                href={href}
                className={`text-sm font-medium transition-colors whitespace-nowrap ${scrolled ? "text-gray-600 hover:text-gray-900" : "text-white/80 hover:text-white"}`}
              >
                {label}
              </a>
            ))}
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="hidden md:block cursor-pointer bg-emerald-500 hover:bg-emerald-600 text-white px-5 py-2 rounded-lg text-sm font-semibold transition-all hover:shadow-lg whitespace-nowrap"
            >
              Try Free Demo →
            </button>
            ...
            <button
              ...
              className={`md:hidden p-1 cursor-pointer ${scrolled || menuOpen ? "text-gray-700" : "text-white"}`}
            >
        ...
        {menuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 px-6 py-4 flex flex-col gap-4">
            ...
            {/* Try Free Demo inside mobile menu */}
            <button
              onClick={() => { setMenuOpen(false); router.push("/cbam"); }}
              className="cursor-pointer bg-emerald-500 hover:bg-emerald-600 text-white px-5 py-2.5 rounded-lg text-sm font-semibold transition-all text-center"
            >
              Try Free Demo →
            </button>
          </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <svg className="absolute bottom-0 left-0 right-0 w-full" viewBox="0 0 1440 320" preserveAspectRatio="none">
          <path d="M0,320 L0,200 L120,120 L240,180 L360,80 L480,160 L600,40 L720,140 L840,60 L960,150 L1080,90 L1200,170 L1320,100 L1440,180 L1440,320 Z" fill="rgba(6,78,59,0.4)" />
          <path d="M0,320 L0,240 L180,160 L300,220 L420,140 L540,200 L660,100 L780,180 L900,120 L1020,200 L1140,140 L1260,210 L1380,150 L1440,200 L1440,320 Z" fill="rgba(4,120,87,0.3)" />
          <path d="M0,320 L0,280 L200,220 L400,260 L600,200 L800,250 L1000,210 L1200,260 L1440,230 L1440,320 Z" fill="rgba(16,185,129,0.2)" />
        </svg>
        ...
        <div className={`relative z-10 text-center px-6 max-w-4xl mx-auto transition-all duration-1000 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() => router.push("/cbam")}
              className="cursor-pointer bg-emerald-500 hover:bg-emerald-400 text-white px-8 py-4 rounded-xl text-base sm:text-lg font-semibold transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-emerald-500/30"
            >
              Try Free Demo →
            </button>
            <a
              href="#timeline"
              className="cursor-pointer border border-white/30 text-white px-8 py-4 rounded-xl text-base sm:text-lg font-semibold hover:bg-white/10 transition-all backdrop-blur text-center"
            >
              Learn about CBAM
            </a>
          </div>
      ...
      <div className="bg-gray-900 py-12 px-6">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {stats.map((s) => (
            <div key={s.num}>
              <div className="text-2xl sm:text-4xl font-bold text-emerald-400 mb-1">{s.num}</div>
      ...
      <section className="py-16 md:py-24 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-emerald-600 text-sm font-bold uppercase tracking-widest mb-4">
            What is CBAM?
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                With ETS prices at <strong>~€70 per tonne of CO₂</strong>, a
                single shipment of 500 tonnes of steel can carry a CBAM cost of
                over <strong>€77,000</strong>.
              </p>
            </div>
            <div className="bg-gray-100 rounded-2xl p-6 md:p-8 border border-gray-200">
              <div className="text-sm font-bold text-gray-500 mb-5 uppercase tracking-wide">
                Cost Calculation Example
              </div>
              <div className="space-y-4">
                {[
                  { label: "Import volume",            value: "500t steel",    color: "bg-blue-50 text-blue-700" },
                  { label: "Emission factor (EU default)", value: "× 2.21 tCO₂/t", color: "bg-orange-50 text-orange-700" },
                  { label: "ETS price",                value: "× €70/tCO₂",   color: "bg-purple-50 text-purple-700" },
                  { label: "CBAM certificate cost",    value: "= €77,350",     color: "bg-emerald-50 text-emerald-700" },
                ].map((row) => (
      ...
      <section className="py-16 md:py-24 px-6 bg-gray-50" id="timeline">
        <div className="max-w-4xl mx-auto">
          <div className="text-emerald-600 text-xs font-bold uppercase tracking-widest mb-4">Timeline</div>
          <h2 className="text-3xl md:text-5xl leading-tight font-bold text-gray-900 mb-12 md:mb-16">
              ...
              {timeline.map((item, i) => (
                <div key={i} className="flex gap-6 md:gap-8 items-start">
                  <div className="w-20 md:w-28 shrink-0 text-right">
                    <span className="text-xs sm:text-sm font-bold text-emerald-600 bg-emerald-50 px-2 md:px-3 py-1 rounded-full border border-emerald-100 whitespace-nowrap">
                      {item.year}
                    </span>
                  </div>
      ...
      <section className="py-16 md:py-24 px-6 bg-white" id="sectors">
        <div className="max-w-5xl mx-auto">
          <div className="text-emerald-600 text-xs font-bold uppercase tracking-widest mb-4">Annex I Coverage</div>
          <h2 className="text-3xl md:text-5xl leading-tight font-bold text-gray-900 mb-4">
            Six sectors under CBAM
          </h2>
          <p className="text-gray-500 mb-10 md:mb-12 max-w-xl text-sm md:text-base">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-5">
            {sectors.map((s) => (
              <div
                key={s.name}
                className="border border-gray-200 rounded-2xl p-4 md:p-6 hover:border-emerald-500 hover:shadow-lg hover:-translate-y-1 transition-all duration-200 cursor-default"
              >
                <div className="text-2xl mb-2 md:mb-3">{s.icon}</div>
                <div className="font-bold text-gray-900 mb-1 text-sm md:text-base">{s.name}</div>
                <div className="text-xs text-emerald-600 font-mono mb-1 md:mb-2">{s.cn}</div>
      ...
      <section className="py-16 md:py-24 px-6 bg-gray-900" id="regulations">
        <div className="max-w-5xl mx-auto">
          <div className="text-emerald-400 text-xs font-bold uppercase tracking-widest mb-4">EU Trade Regulations</div>
          <h2 className="text-3xl sm:text-5xl font-bold text-white mb-4">Beyond CBAM</h2>
          <p className="text-gray-400 mb-10 md:mb-12 max-w-xl text-sm">
            European trade compliance is expanding. AlpineScope is built to grow with every new regulation.
          </p>
          <div className="grid md:grid-cols-3 gap-5 md:gap-6">
            {regulations.map((r) => (
              <div key={r.title} className="bg-gray-800 border border-gray-700 rounded-2xl p-5 md:p-6 hover:border-emerald-500/40 transition-all">
                <div className="text-2xl mb-3 md:mb-4">{r.icon}</div>
                <div className="font-bold text-white text-base mb-1">{r.title}</div>
                <div className="text-emerald-400 text-xs font-medium mb-2 md:mb-3">{r.subtitle}</div>
      ...
      <section className="py-16 md:py-24 px-6 bg-white" id="about">
        <div className="max-w-5xl mx-auto">
          <div className="text-emerald-600 text-xs font-bold uppercase tracking-widest mb-4">How It Works</div>
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-10">
            {[
              ...
              <div key={step.num} className="bg-gray-50 border border-gray-100 p-6 rounded-2xl">
                <div className="text-4xl md:text-5xl font-bold text-gray-200 mb-3 leading-none">{step.num}</div>
                <div className="text-2xl mb-2 md:mb-3">{step.icon}</div>
      ...
      <section className="relative py-24 md:py-32 px-6 overflow-hidden">
        ...
        <svg className="absolute bottom-0 left-0 right-0 w-full opacity-10" viewBox="0 0 1440 200" preserveAspectRatio="none">
          <path d="M0,200 L0,100 L240,60 L480,120 L720,40 L960,100 L1200,60 L1440,100 L1440,200 Z" fill="white" />
        </svg>
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          ...
          <p className="text-white/60 mb-8 md:mb-10 text-base md:text-lg">
            Free to use. No sign-up required. Get a compliance report in under 60 seconds.
          </p>
          <button
            onClick={() => router.push("/cbam")}
            className="cursor-pointer bg-emerald-500 hover:bg-emerald-400 text-white px-8 md:px-10 py-4 rounded-xl text-base md:text-lg font-semibold transition-all hover:-translate-y-1 hover:shadow-2xl hover:shadow-emerald-500/30"
          >
            Start Free Demo →
          </button>
      ...
      <footer className="bg-gray-950 py-10 px-6">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            <a target="_blank" href="https://www.linkedin.com/in/avinashpalakurthi0721" className="text-gray-500 hover:text-emerald-400 text-sm transition-colors">
              LinkedIn
            </a>
            <a target="_blank" href="mailto:palakurthiavinash07@gmail.com" className="text-gray-500 hover:text-emerald-400 text-sm transition-colors">
              Contact
            </a>
          </div>
